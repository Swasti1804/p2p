        ...
        >
          <Card className="border-yellow-500/20 bg-gradient-to-br from-yellow-50/50 to-orange-50/50 dark:from-yellow-950/20 dark:to-orange-950/20">
            <CardHeader className="text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-yellow-500/10 mb-4 mx-auto">
                <Workflow className="h-7 w-7 text-yellow-600 dark:text-yellow-400" />
              </div>
              <CardTitle className="text-3xl font-bold">
                AI Agent Workflow Generator
              </CardTitle>
              <CardDescription className="text-lg mt-2">
                <Badge className="bg-yellow-500 text-white hover:bg-yellow-600 mb-2 text-sm">
                  💲 PAID TIER - $10/month
                </Badge>
                <br />
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <Textarea
                  ...
                  rows={4}
                  className="resize-none placeholder:text-base sm:placeholder:text-lg text-base"
                />
              </div>
